...
func (a *ModApiService) GetExecute(r ModApiGetRequest) (*Mod, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *Mod
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ModApiService.Get")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mod/{mod_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"mod_name"+"}", url.PathEscape(parameterValueToString(r.modName, "modName")), -1)
